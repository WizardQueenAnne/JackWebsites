        ...
        if (message !== '') {
            ...
            setTimeout(() => {
                ...
                if (message.toLowerCase().includes('pricing') || message.toLowerCase().includes('cost') || message.toLowerCase().includes('price')) {
                    ...
                    botResponse = "You can reach me at jacksseattlewebsites@gmail.com or call/text me at (206) 555-1234. I'm usually available on weekdays after 3:30 PM and weekends all day.";
                } else {
